...
with open('foodcrust_evidence_09_06_23.csv','r', encoding='utf-8-sig') as csvinput:
    with open('foodcrust_evidence_deblanked.csv', 'w') as csvoutput:
        writer = csv.writer(csvoutput, lineterminator='\n')
        reader = csv.reader(csvinput)

        # calculate threshhold
        threshold=1.21306131943
